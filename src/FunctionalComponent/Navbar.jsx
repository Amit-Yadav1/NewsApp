              ...
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li className="nav-item dropdown">
                  ...
                  >
                    <button
                      className="dropdown-item text-dark"
                      onClick={() => props.changePageSize("8")}
                    >
                      8
                    </button>
                    <button
                      className="dropdown-item text-dark"
                      onClick={() => props.changePageSize("12")}
                    >
                      12
                    </button>
                    <button
                      className="dropdown-item text-dark"
                      onClick={() => props.changePageSize("16")}
                    >
                      16
                    </button>
                    <button
                      className="dropdown-item text-dark"
                      onClick={() => props.changePageSize("20")}
                    >
                      20
                    </button>
                    <button
                      className="dropdown-item text-dark"
                      onClick={() => props.changePageSize("24")}
                    >
                      24
                    </button>
                  </ul>
